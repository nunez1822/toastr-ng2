...
var Overlay = (function () {
    function Overlay(_overlayContainer, _componentResolver) {
    ...
    Overlay.prototype.create = function (positionClass) {
        var _this = this;
        return this.getPaneElement(positionClass).then(function (pane) { return _this._createOverlayRef(pane); });
    };
    ...
    Overlay = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [overlay_container_1.OverlayContainer, core_1.ComponentResolver])
    ], Overlay);
    return Overlay;
}());
